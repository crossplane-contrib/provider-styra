# Building and Installing the Crossplane styra Provider

`provider-styra` is composed of a golang project and can be built directly with
...
You can build the Crossplane styra Provider for the host platform by
